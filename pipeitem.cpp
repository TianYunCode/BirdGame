...
{
    //画上管道
    painter->drawImage(QRectF(m_scene->width(), 0, PIPE_WIDTH,m_upPipeHeight), QImage(":/BirdGame/Resources/image/tubeup.png"));
    painter->drawImage(QRectF(m_scene->width(),m_upPipeHeight + 140, PIPE_WIDTH,m_downPipeHeight), QImage(":/BirdGame/Resources/image/tubedown.png"));
}
